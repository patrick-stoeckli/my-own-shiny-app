  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel(title = "Data",
                           h3("App description"),
                           p("This is the demo shiny app. It is created during the course
                            demonstrations and explanations using the demo data:", br(),
                            strong("Wind speed"), "(in knots) and ", br(),
                            strong("Air pressure"), "(in millibars) of storms from around
